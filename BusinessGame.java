...
public class BusinessGame {
    ...
    public void start() {
        ...
        if(numberOfPlayers<2) {
            System.out.println("controller.BusinessGame requires minimum of two players.");
        } else {
            char[] positionsOfBoard = businessGameBoard.getPositionsOfBoard();
            HashMap<HotelCell,Integer> hotelsList = (HashMap<HotelCell, Integer>) businessGameBoard.getHotelsList();
